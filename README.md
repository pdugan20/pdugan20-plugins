...
| --- | --- |
| [Patrick Skills](https://github.com/pdugan20/skills/tree/v2.0.0) | Design exploration, feature delivery, and production hardening skills |
| [Mintlify Docs](https://github.com/pdugan20/mintlify-docs/tree/v0.3.3) | Documentation authoring and review skills |
...
Each source is pinned to a release tag. Marketplace releases use the matching section of [CHANGELOG.md](CHANGELOG.md) as their GitHub Release notes.
